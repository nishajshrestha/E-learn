    ...
    <div class="box-container">
        ...
        if ($count2 > 0) {
            while ($row2 = mysqli_fetch_assoc($res2)) {
                ...
                $category_description = $row2['description'];
                ?>
                <div class="box">
...
<section class="about" id="about">
    ...
    <div class="content">
        ...
        <p>Our course enables learners to access educational materials, interact with instructors and fellow students, and participate in learning activities remotely, without the need for physical presence in a traditional classroom setting.</p>
...
<div class="courses__box-wrapper">
  ...
  include('../connect.php');
    ...
    <div class="box">
        <div class="content">
            ...
            <a href="coursesdetail.php?id=<?php echo $row['course_id']; ?>"><button class="btn">view pdf</button></a>
        </div>
    </div>
